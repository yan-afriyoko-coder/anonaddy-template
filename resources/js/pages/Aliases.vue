  ...
  <div class="aliases ">
    ...
    <div class="card bg-white p-2 rounded shadow overflow-x-auto mt-12">
      <div class="card-title aliases-title p-3">
        ...
        <div class="mb-6 mt-3 flex flex-col md:flex-row justify-between md:items-center">
      
          <div class="flex flex-wrap mt-4 md:mt-0">
            <div>
              <button
                @click="generateAliasModalOpen = true"
                class="text-white new-aliases py-3 px-4 ml-5 rounded focus:outline-none ml-auto"
              >
              <icon
                name="plus"
                class=" w-5 h-full text-white inline-block fill-current mr-1  items-center cursor-pointer"
              /> Create New Alias
              </button>
            </div>
            ...
            <div class="block relative mr-4">
              <select
                v-model="showAliases"
                class="block appearance-none hide-btn w-full text-grey-700 bg-white p-3 pr-8 rounded mx-3 focus:ring"
                required
              >
          ...
          <div class="relative">
            <input
              ...
              tabindex="0"
              type="text"
              class="w-full md:w-64 appearance-none aliases-search text-grey-800 focus:outline-none rounded py-3 pl-3 pr-8"
              placeholder="Search"
            />
            <icon
              v-if="search"
            ...
            <icon
              v-else
              name="search"
              class="absolute right-0 inset-y-0 w-5 h-full text-grey-600 fill-current pointer-events-none mr-2 flex items-center"
            />
          </div>
